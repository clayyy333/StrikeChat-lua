...
function ProfileUI.Create(parent, Theme, profile, player)
    ...
    leftPanelShadow.Size = UDim2.new(0.45, 2, 1, 10)
    leftPanelShadow.Position = UDim2.new(0, -6, 0, -5)
    leftPanelShadow.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    leftPanelShadow.BackgroundTransparency = 0.62
    leftPanelShadow.BorderSizePixel = 0
    leftPanelShadow.Parent = content
    round(leftPanelShadow, 18)
    ...
    leftPanelShadowGradient.Rotation = 18
