...
local esToEn = {
    ...
    ["La fuente no tiene un enlace directo de descarga."] = "The source does not provide a direct download link.",
    ["La fuente devolvio una pagina, no un archivo multimedia."] = "The source returned a page, not a media file.",
    ["La fuente no entrego el formato solicitado."] = "The source did not provide the requested format.",
    ["No se pudo registrar la descarga local."] = "The local download could not be registered.",
