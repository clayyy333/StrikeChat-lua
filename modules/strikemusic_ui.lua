...
function StrikeMusicUI.Create(parent, Theme)
    ...
    local searchHolder = createPanel(root, "SearchHolder", UDim2.new(0.52, 0, 0, 46), UDim2.new(0, 282, 0, 22))
    ...
    local centerPanel = createPanel(root, "CenterPanel", UDim2.new(1, -666, 1, -206), UDim2.new(0, 260, 0, 86))
    centerPanel.BackgroundTransparency = 0.19

    local rightPanel = createPanel(root, "RightPanel", UDim2.new(0, 382, 1, -108), UDim2.new(1, -392, 0, 86))
    ...
    bottomControls.Size = UDim2.new(0, 420, 0, 50)
    bottomControls.Position = UDim2.new(0.5, -210, 0, 8)
    bottomControls.BackgroundTransparency = 1
    bottomControls.Parent = bottomPlayer

    createIconButton(bottomControls, "ShuffleButton", "x", UDim2.new(0, 34, 0, 34), UDim2.new(0, 36, 0.5, -17)).BackgroundTransparency = 1
    createIconButton(bottomControls, "PreviousButton", "|<", UDim2.new(0, 36, 0, 36), UDim2.new(0, 92, 0.5, -18)).BackgroundTransparency = 1
    local bottomPlay = createIconButton(bottomControls, "PlayButton", "||", UDim2.new(0, 50, 0, 50), UDim2.new(0.5, -25, 0, 0))
    bottomPlay.BackgroundColor3 = COLORS.Purple
    createCorner(bottomPlay, 25)
    createIconButton(bottomControls, "NextButton", ">|", UDim2.new(0, 36, 0, 36), UDim2.new(1, -128, 0.5, -18)).BackgroundTransparency = 1
    createIconButton(bottomControls, "RepeatButton", "o", UDim2.new(0, 34, 0, 34), UDim2.new(1, -70, 0.5, -17)).BackgroundTransparency = 1

    local bottomProgress, bottomProgressFill = createProgress(bottomPlayer, UDim2.new(0.31, 0, 0, 70), UDim2.new(0.38, 0, 0, 4), 0)
    local bottomCurrent = createLabel(bottomPlayer, "CurrentTime", "0:00", UDim2.new(0, 48, 0, 20), UDim2.new(0.28, 0, 0, 62), 10, Enum.Font.Gotham, COLORS.Muted)
    local bottomTotal = createLabel(bottomPlayer, "TotalTime", "0:00", UDim2.new(0, 48, 0, 20), UDim2.new(0.69, 0, 0, 62), 10, Enum.Font.Gotham, COLORS.Muted)
    ...
    local api = {
        ...
        RenderSearchResults = function(items)
            renderCards(searchList, items, "Busca musica o pega un link para ver resultados.", 210, 198, 4)
        end,
    ...
    if _G.StrikeChatLayoutMode == "mobile" then
        sideBar.Size = UDim2.new(0, 210, 1, -100)
        centerPanel.Position = UDim2.new(0, 226, 0, 76)
        centerPanel.Size = UDim2.new(1, -590, 1, -190)
        rightPanel.Size = UDim2.new(0, 350, 1, -100)
        rightPanel.Position = UDim2.new(1, -360, 0, 76)
        bottomPlayer.Size = UDim2.new(1, -16, 0, 86)
        bottomPlayer.Position = UDim2.new(0, 8, 1, -94)
        searchHolder.Position = UDim2.new(0, 258, 0, 18)
